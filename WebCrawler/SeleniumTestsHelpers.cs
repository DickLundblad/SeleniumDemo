    ...
    public static class SeleniumTestsHelpers
    {
        ...
        public static void WriteListOfLinkedInPeopleToFile(List<PeopleLinkedInDetail> results, string filePath, string subFolder = "")
        {
            ...
            using (var csvR = new CsvReader(reader, config))
            {
                ...
                Console.WriteLine($"Validated that the file contains {records.Count} PeopleLinkedInDetail .");
            }
        }
        ...
        public static void WriteToFile(PeopleLinkedInDetails results, string filePath, string subFolder = "")
        {
            ...
            using (var csv = new CsvWriter(writer, config))
            {
                ...
                foreach (var jobListing in results.PeopleLinkedInDetailsList)
                {
                    ...
                    {
                        Console.WriteLine($"OrgNumber is empty for company listing: {jobListing.Name}");
                    }
                }
            }
